...
public class PeachPie implements IDesert {

    private final String currentPrice;
    private final String currentDiscount;

    public PeachPie(String currentPrice, String currentDiscount) {
    ...
    public String getHistory() {
        return "Peach pie is a pie made with peaches as primary ingredient. " +
